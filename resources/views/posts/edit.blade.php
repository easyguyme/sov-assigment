...
@section('content')
    ...
    <div class="container-fluid">
        <div class="page-header min-height-100 border-radius-xl mt-4" style="background-image: url('{{asset('assets')}}/img/curved-images/curved0.jpg'); background-position-y: 30%;">
            <span class="mask bg-gradient-primary opacity-6"></span>
        </div>
        <div class="card  blur shadow-blur mx-4 mt-n6">
            <div class="card-header shadow-blur pb-0 px-3">
                <h6 class="mb-0">{{ __('Update Post') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{route('posts.update',$post->id)}}" method="POST" role="form text-left" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('title')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Post title" id="title" value="{{ old('title', $post->title) }}" name="title" required>
                                    @error('title')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('excerpt')border border-danger rounded-3 @enderror">
                                    <textarea class="form-control" id="excerpt" rows="3" placeholder="Summarize your post" name="excerpt" required>{{ old('excerpt', $post->excerpt) }}</textarea>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="@error('content')border border-danger h-50 @enderror">
                                <textarea class="form-control h-50" id="content" rows="5" placeholder="Let loose your writing prowess" name="content" >{{ old('content', $post->content) }}</textarea>
                            </div>
                        ...
                        <div class="col-md-6 col-sm">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <img id="image-preview" src="{{ url('uploads/',$post->image) }}" class="img-thumbnail" height="500px" width="500px" style=" height: 50%; ">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="align-content-center text-center align-center">
                        <button type="submit" class="btn bg-gradient-success btn-lg mt-4 mb-4">{{ 'Update Post' }}</button>
                    </div>
                </form>
